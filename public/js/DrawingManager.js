...
(function() {
     ...
     */
    DrawingManager.prototype.setDrawingMode = function(drawingType, points) {
        //与当前模式不一样时候才进行重新绑定事件
        // if (this._drawingType != drawingType) {
            closeInstanceExcept(this);
            this._setDrawingMode(drawingType, points);
        // }
    }
     ...
     * @param {DrawingType}
     */
    DrawingManager.prototype._setDrawingMode = function(drawingType, points) {
        ...
        if (this._isOpen) {
            ...
            switch (drawingType) {
                ...
                case BMAP_DRAWING_POLYGON:
                    this._bindPolylineOrPolygon(points);
                    break;
     ...
     */
    DrawingManager.prototype._bindPolylineOrPolygon = function(points) {

        var me           = this,
            map          = this._map,
            mask         = this._mask,
            points       = points || [],   //用户绘制的点
        ...
        var startAction = function (e) {
            ...
            if (points.length == 1 || !overlay) {
                ...
                overlay.addEventListener("dblclick", toggleEdit);
        ...
        var dblclickAction = function (e) {
            ...
            else if(baidu.ie <= 8 || me._isCheckPoint){
            }else{
                points.pop();
            }
