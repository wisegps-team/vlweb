...
(function() {
    ...
    CityList.prototype._initContainer = function () {
        ...
        function getAreaData(data){
            ...
            if(data.content){
                ...
                if(data.content.area_code == 1){
                    ...
                    baidu.__map.centerAndZoom(point, 12);
                }else{
                    var point = new BMap.Point(po.lng, po.lat);
                    baidu.__map.centerAndZoom(point, selectArea.level);
                }
                /*渲染城市*/
                if(data.content.sub){
                    subList = c.sub;
        ...
        baidu.__map.addOverlay(polygon);
        polygon.hide();
        baidu.on(businessDom, "change", function(e){
            ...
            baidu.__map.setViewport(business_geo);
