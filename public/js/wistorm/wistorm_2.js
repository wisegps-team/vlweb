...
//    remark: 描述;
//    pay_count: 续费数量
//    pay_type: 续费类型：1：年付 2：月付
//    product_type //1: 服务费 2: 流量费
//    attach: 车辆ID;
// 返回：
// WiStormAPI.prototype.payService = function (uid, bill_type, pay_type, pay_count, product_type, remark, attach, callback) {
//     this.init();
//     this.sign_obj.method = 'wicare.pay.service.v2';
//     this.sign_obj.dev_key = dev_key;
//     this.sign_obj.uid = uid;
//     this.sign_obj.bill_type = bill_type;
//     this.sign_obj.pay_type = pay_type;
//     this.sign_obj.pay_count = pay_count;
//     this.sign_obj.product_type = product_type;
//     this.sign_obj.remark = remark;
//     this.sign_obj.attach = attach;
//     this.sign_obj.sign = this.sign();
//     var params = raw2(this.sign_obj);
//     var path = API_URL + "/router/rest?" + params;
//     _post(path, function (obj) {
//         callback(obj);
//     });
// };
// 续费接口如下：
...
//    attach: 车辆ID;
// 返回：
WiStormAPI.prototype.payService = function (uid, to_uid, product_type, bill_type, pay_type, pay_count, remark, attach, callback) {
    this.init();
    this.sign_obj.method = 'wicare.pay.service.v2';
    var obj = {
        data: {
...
//    id: 套餐Id，对应servicePlan.name
//    pay_count: 购买数量;
//    remark: 描述;
// 返回：
WiStormAPI.prototype.payServicePlan = function (uid, to_uid, id, pay_count, remark, callback) {
    this.init();
    this.sign_obj.method = 'wicare.pay.servicePlan';
    var obj = {
        data: {
            uid: uid,
            to_uid: to_uid,
...
// 购买服务套餐
// 参数:
//    order_type: //订单类型(1: 商品 2: 充值 3: 提现 4: 余额支付 5:退款 7: 充押金 8:退押金 9:购买游戏币 13:购买服务套餐)
// 返回：
// WiStormAPI.prototype.getOrderList = function (uid, start_time, end_time, order_type, token, callback) {
//     this.init();
//     this.sign_obj.method = 'wicare.order.list';
...
// end_time: 结束时间
// order_type: //订单类型(1: 商品 2: 充值 3: 提现 4: 余额支付 5:退款 7: 充押金 8:退押金 9:购买游戏币 13:购买服务套餐)
WiStormAPI.prototype.getOrderList = function (uid, start_time, end_time, order_type, page_no, limit, token, callback) {
    this.init();
    this.sign_obj.method = 'wicare.order.list';
    this.sign_obj.access_token = token;
    this.sign_obj.uid = uid;
...
WiStormAPI.prototype.getOrderListUrl = function (uid, start_time, end_time, order_type, page_no, limit, token) {
    this.init();
    this.sign_obj.method = 'wicare.order.list';
    this.sign_obj.access_token = token;
    this.sign_obj.uid = uid;
...
// 返回：
//    微信JSAPI支付参数
WiStormAPI.prototype.payBalance = function (uid, to_uid, bill_type, amount, remark, attach, callback) {
    this.init();
    this.sign_obj.method = 'wicare.pay.balance';
    this.sign_obj.dev_key = dev_key;
    this.sign_obj.uid = uid;
    this.sign_obj.to_uid = to_uid;
    this.sign_obj.bill_type = bill_type;
    this.sign_obj.amount = amount;
    this.sign_obj.remark = remark;
    this.sign_obj.attach = attach;
    this.sign_obj.sign = this.sign();
    var params = raw2(this.sign_obj);
...
// 参数:
//    uid: 管理用户ID;
//    fee_type: 支付类型: (1: 按时间计费， 2: 按年计费 3: 按月计费)
//    duration: 时长;
// 返回：
//    微信JSAPI支付参数
WiStormAPI.prototype.payGetFee = function (uid, fee_type, duration, callback) {
    this.init();
    this.sign_obj.method = 'wicare.pay.getFee';
    this.sign_obj.dev_key = dev_key;
    this.sign_obj.uid = uid;
    this.sign_obj.fee_type = fee_type;
