...
webpackJsonp([1], {
    0: function (e, exports, t) {
        ...
        !function () {
            ...
            angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function (e, a, n, i, o, c, r, s, l, d, f, u, m, g, p, h, M, v, y) {
                ...
                e.$watchCollection("chatContent", function (e) {
                    if (e.length > 0 && e[e.length - 1].FromUserName === s.getUserName())N = !0; else {
        ...
        !function () {
            "use strict";
            angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory",
                "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService",
                ...
                var I, P, A = document.getElementById("caretPosHelper"), U = 0, F = 0, x = document.getElementById("editArea"), V = x.parentNode, D = f.getShareObject("editingContents"), R = !1;
                $(x).on("input", function () {
                    M()
                }).on("click", function () {
                    M()
            ...
            angular.module("Services").factory("appFactory", ["$http", "$q", "confFactory", "accountFactory", "loginFactory", "utilFactory", "reportService", "mmHttp", function (e, t, a, n, i, o, c, r) {
                var s = {
                    globalData: {chatList: []}, init: function () {
                        ...
                        var e = t.defer(), r = this, s = a.API_synccheck + "?" + ["r=" + o.now(), "skey=" + encodeURIComponent(n.getSkey()), "sid=" + encodeURIComponent(n.getSid()), "uin=" + n.getUin(), "deviceid=" + n.getDeviceID(), "synckey=" + encodeURIComponent(n.getFormateSyncCheckKey())].join("&");
